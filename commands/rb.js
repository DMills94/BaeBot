...
const { storeBeatmap } = require('../databases/requests/lastBeatmap.js')
...
module.exports = {
    ...
    async execute(m, args, emojis, rbNum) {
        ...
        for (let score in unsortedTopScores) {
            ...
            unsortedTopScores[score].date = Date.parse(unsortedTopScores[score].date) + 0 
        }
        ...
        storeBeatmap(m.channel.id, beatmapInfo, usersScore)
    }
}